...
function WhatToAsk() {
  return (
    <section
      id="about"
      className="relative pt-25 pb-32 px-6  overflow-hidden bg-linear-to-b from-background to-muted/20">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            From simple questions to complex concerns, we provide helpful and
            reliable dental guidance instantly.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="group relative">
                <div className="bg-linear-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:scale-[1.02] group-hover:-translate-y-1">
          ...
          <div className="bg-linear-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:scale-[1.02]">
