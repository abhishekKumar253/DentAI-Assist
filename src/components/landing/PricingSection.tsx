...
function PricingSection() {
  return (
    <section
      id="pricing"
      className="relative py-24 px-6 overflow-hidden bg-linear-to-b from-background via-muted/3 to-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="relative group">
            <div className="relative bg-linear-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500  hover:shadow-2xl hover:shadow-primary/10 hover:scale-[1.02]">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-linear-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-[1.03] hover:scale-[1.05]">
              <div className="space-y-6">
                <div className="space-y-3">
